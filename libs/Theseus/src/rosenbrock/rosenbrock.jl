...
function (::RosenbrockAlgorithm{N})(res, uₙ, Δt, f!, du, u, p, t, stages, stage, workspace, RK, assume_p_const) where N
    invdt = inv(Δt)
    F!(du, u, p) = f!(du, u, p, t)
    @. u = uₙ
    @. res = 0
...
function RosenbrockOptions(callback, tspan; maxiters=typemax(Int), verbose=0, krylov_algo=:gmres, assume_p_const=true, krylov_kwargs=(;), kwargs...)
