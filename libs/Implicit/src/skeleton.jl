...
function nonlinear_problem(alg::SimpleImplicitExplicitAlgorithm, f2::F2) where {F2}
    return (res, u, (uₙ, Δt, f1, du, du_tmp, p, t, stages, stage, RK)) -> alg(res, uₙ, Δt, f1, f2, du, du_tmp, u, p, t, stages, stage, RK)
end
...
function RKTableau(alg::RKImplicitExplicitEuler)
    return ImplicitExplicitEulerTableau()
end

function ImplicitExplicitEulerTableau()
